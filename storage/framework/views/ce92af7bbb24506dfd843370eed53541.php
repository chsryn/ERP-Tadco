...
<head>
    <meta charset="UTF-8">
    <title><?php echo $__env->yieldContent('title', 'ERP TADCO'); ?></title>
    ...
    <link href="<?php echo e(asset('css/metronic.css')); ?>" rel="stylesheet">
</head>
...
<body>
    <div class="app-shell">
        <aside class="sidebar">
            <div class="brand">
                <img src="<?php echo e(asset('images/Tadco-TP2.png')); ?>" alt="TADCO ERP" class="brand-logo">
            ...
            <nav class="sidebar-nav">
                ...
                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'admin|sales')): ?>
                    <div class="sidebar-group">
                        <button type="button"
                            class="sidebar-group-toggle <?php echo e(request()->routeIs('inventory.*') || request()->routeIs('delivery_orders.*') || request()->routeIs('shipments.*') ? 'active' : ''); ?>"
                        ...
                        <div class="sidebar-submenu <?php echo e(request()->routeIs('inventory.*') || request()->routeIs('delivery_orders.*') || request()->routeIs('shipments.*') ? 'open' : ''); ?>"
                            id="inventory-group">
                            <a href="<?php echo e(route('inventory.index')); ?>"
                                class="sidebar-link <?php echo e(request()->routeIs('inventory.*') ? 'active' : ''); ?>">
                                <i class="bi bi-stack"></i>
                                <span>Inventory</span>
                            </a>
                            <a href="<?php echo e(route('delivery_orders.index')); ?>"
                                class="sidebar-link <?php echo e(request()->routeIs('delivery_orders.*') ? 'active' : ''); ?>">
                                <i class="bi bi-receipt"></i>
                                <span>Delivery Orders</span>
                            </a>
                            <a href="<?php echo e(route('shipments.index')); ?>"
                                class="sidebar-link <?php echo e(request()->routeIs('shipments.*') ? 'active' : ''); ?>">
                    ...
                    <div class="sidebar-group">
                        <button type="button"
                            class="sidebar-group-toggle <?php echo e(request()->routeIs('customers.*') || request()->routeIs('products.*') ? 'active' : ''); ?>"
                        ...
                        <div class="sidebar-submenu <?php echo e(request()->routeIs('customers.*') || request()->routeIs('products.*') ? 'open' : ''); ?>"
                            id="master-group">
                    ...
                    <div class="sidebar-group">
                        <button type="button"
                            class="sidebar-group-toggle <?php echo e(request()->routeIs('invoices.*') || request()->routeIs('payments.*') ? 'active' : ''); ?>"
                        ...
                        <div class="sidebar-submenu <?php echo e(request()->routeIs('invoices.*') || request()->routeIs('payments.*') ? 'open' : ''); ?>"
                            id="finance-group">
                            <a href="<?php echo e(route('invoices.index')); ?>"
                                class="sidebar-link <?php echo e(request()->routeIs('invoices.*') ? 'active' : ''); ?>">
                    ...
                    <div class="sidebar-group">
                        <button type="button"
                            class="sidebar-group-toggle <?php echo e(request()->routeIs('users.*') || request()->routeIs('imports.*') || request()->routeIs('reports.*') ? 'active' : ''); ?>"
                        ...
                        <div class="sidebar-submenu <?php echo e(request()->routeIs('users.*') || request()->routeIs('imports.*') || request()->routeIs('reports.*') ? 'open' : ''); ?>"
                            id="settings-group">
                            ...
                            <a href="<?php echo e(route('imports.index')); ?>"
                                class="sidebar-link <?php echo e(request()->routeIs('imports.*') ? 'active' : ''); ?>">
            ...
            <div class="sidebar-footer">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div class="overflow-hidden">
                        ...
                        <strong class="d-block text-white text-truncate" style="font-size: 13px;"><?php echo e(Auth::user()->name); ?></strong>
                    </div>
                </div>
                <?php endif; ?>
            </div>
        ...
        <main class="main-content">
            <div class="topbar">
                ...
                <div class="topbar-actions">
                                    ...
                                    <li>
                                        <a class="dropdown-item py-2" href="#">
                                            <div class="d-flex align-items-start gap-2">
                                                ...
                                                <div>
                                                    <small class="d-block text-dark fw-medium text-wrap"><?php echo e($notification->data['message'] ?? 'Pemberitahuan baru'); ?></small>
                    ...
                    <div class="dropdown d-inline-block ms-1">
                        <?php if(auth()->guard()->check()): ?>
                        <div class="user-avatar" role="button" data-bs-toggle="dropdown" aria-expanded="false" title="<?php echo e(Auth::user()->name); ?>">
                            <?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 rounded-4 mt-2 pb-2">
                            <li class="px-3 py-2 text-center border-bottom mb-2">
                                <strong class="d-block text-dark"><?php echo e(Auth::user()->name); ?></strong>
            ...
            <div class="content-canvas">
                <div class="page-heading">
                    <div>
                        <h4><?php echo $__env->yieldContent('page_title', 'ERP TADCO'); ?></h4>
                        <small><?php echo $__env->yieldContent('page_subtitle', 'Sistem informasi distribusi PT TADCO'); ?></small>
                    </div>
                ...
                <div class="footer-panel">
                    <p>ERP TADCO © <?php echo e(date('Y')); ?>. Kelola inventaris, transaksi, dan laporan dengan mudah.</p>
                    <div class="footer-links">
                        <a href="<?php echo e(route('dashboard.index')); ?>">Dashboard</a>
                        <a href="<?php echo e(route('reports.index')); ?>">Reports</a>
                        <a href="<?php echo e(route('imports.index')); ?>">Import Excel</a>
                    </div>
                </div>
            </div>
        </main>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const performSearch = (query) => {
                ...
                fetch(`<?php echo e(route('search.global')); ?>?q=${encodeURIComponent(query)}`)
                    .then(res => res.json())
                    .then(data => {
                        searchSpinner.classList.add('d-none');
                        searchIcon.classList.remove('d-none');
...
<?php /**PATH C:\laragon\www\ERP-Tadco\resources\views/layouts/app.blade.php ENDPATH**/ ?>