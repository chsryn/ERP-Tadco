<?php $__env->startSection('title', 'Inventory - ERP TADCO'); ?>
<?php $__env->startSection('page_title', 'Monitoring Stok Barang'); ?>
<?php $__env->startSection('page_subtitle', 'Perhitungan pergerakan stok barang secara real-time'); ?>

<?php $__env->startSection('page_action'); ?>
<a href="<?php echo e(route('inventory.adjustment.create')); ?>" class="btn btn-primary px-4 rounded-pill fw-semibold shadow-sm">
...
<div class="card border-0 shadow-sm rounded-4 mb-4">
    <div class="card-body p-3">
        <form method="GET" action="<?php echo e(route('inventory.index')); ?>" class="row g-2">
            <div class="col-md-8">
                <div class="input-group">
                    <span class="input-group-text bg-light border-end-0 text-muted"><i class="bi bi-search"></i></span>
                    <input type="text" name="search" class="form-control bg-light border-start-0"
                        placeholder="Cari kode produk, nama produk, segment..." value="<?php echo e($search ?? ''); ?>">
                </div>
            </div>
        ...
        <table class="table table-hover table-bordered border-light align-middle mb-0">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $stocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <tr>
                        <td class="text-center fw-medium text-secondary text-nowrap"><?php echo e($stocks->firstItem() + $loop->index); ?></td>
                        <td class="fw-semibold text-dark col-inv-prod"><?php echo e($stock->product->product_name ?? '-'); ?></td>
                        <td class="fw-bold text-dark text-nowrap col-inv-code"><?php echo e($stock->product->product_code ?? '-'); ?></td>
                        <td class="text-center text-nowrap col-inv-uom">
                            <?php
                                $uom = strtoupper($stock->product->uom ?? 'BOX');
                            ?>
                            <span class="badge <?php echo e($uom === 'SACK' ? 'bg-warning-subtle text-warning-emphasis' : 'bg-info-subtle text-info-emphasis'); ?> px-3 py-1 rounded-pill fw-bold">
                                <?php echo e($uom); ?>

                            </span>
                        </td>
                        <td class="text-nowrap col-inv-segment"><?php echo e($stock->product->segment ?? '-'); ?></td>
                        <td class="text-end fw-medium text-dark text-nowrap col-inv-avail"><?php echo e(number_format($qtyAvailable, 0, ',', '.')); ?></td>
                        <td class="text-end fw-medium text-warning text-nowrap col-inv-res"><?php echo e(number_format($qtyReserved, 0, ',', '.')); ?></td>
                        <td class="text-end fw-bold text-success text-nowrap col-inv-ready"><?php echo e(number_format($qtyNet, 0, ',', '.')); ?></td>
                        <td class="text-center text-nowrap">
                            <div class="d-flex justify-content-center gap-2">
                                <a href="<?php echo e(route('inventory.show', $stock)); ?>" class="btn btn-sm btn-light border text-info rounded d-inline-flex align-items-center justify-content-center shadow-sm" style="width: 32px; height: 32px;" title="Riwayat Mutasi"><i class="bi bi-clock-history"></i></a>
                            </div>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ERP-Tadco\resources\views/inventory/index.blade.php ENDPATH**/ ?>