...
@section('title', 'Tambah Customer - ERP TADCO')
@section('page_title', 'Tambah Customer Baru')
@section('page_subtitle', 'Pendaftaran data pelanggan baru ke sistem ERP')
                ...
                <div class="card-body px-4 pb-4">
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="customer_code" class="form-control bg-light" value="{{ old('customer_code', $nextCustomerCode ?? '') }}" placeholder="Contoh: CUST-01" readonly>
                        </div>

                        <div class="col-md-8">
                            <label class="form-label fw-semibold small text-secondary">Nama Customer <span class="text-danger">*</span></label>
                            <input type="text" name="customer_name" class="form-control bg-light" value="{{ old('customer_name') }}" placeholder="Nama Toko / Perusahaan" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                ...
                <div class="card-body px-4 pb-4">
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="province" class="form-control bg-light" value="{{ old('province') }}">
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-semibold small text-secondary">Kota / Kabupaten</label>
                            <input type="text" name="city" class="form-control bg-light" value="{{ old('city') }}">
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-semibold small text-secondary">Kecamatan</label>
                            <input type="text" name="district" class="form-control bg-light" value="{{ old('district') }}">
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-semibold small text-secondary">Kelurahan / Desa</label>
                            <input type="text" name="sub_district" class="form-control bg-light" value="{{ old('sub_district') }}">
                        </div>

                        <div class="col-12">
                            <label class="form-label fw-semibold small text-secondary">Alamat Lengkap Jalan</label>
                            <textarea name="address" class="form-control bg-light" rows="3" placeholder="Alamat lengkap toko / gudang customer...">{{ old('address') }}</textarea>
                        </div>
                ...
                <div class="card-footer bg-white py-3 px-4 border-top border-light d-flex justify-content-between align-items-center rounded-bottom-4">
                    ...
                    <button type="submit" class="btn btn-primary px-5 rounded-pill fw-semibold shadow-sm">
                        <i class="bi bi-check-circle me-1"></i> Simpan Customer
                    </button>
                </div>
            </div>
        </form>
