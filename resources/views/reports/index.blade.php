...
@section('page_title', 'Reporting Dashboard')
@section('page_subtitle', 'Visualisasi data operasional, penjualan, piutang, dan pembayaran')
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-3 small text-muted">
                        Total <strong class="text-danger">{{ $lowStockCount }}</strong> Produk berstatus Low Stock (Sisa ≤
                        10)
                    </div>
                </div>
            </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            new Chart(document.getElementById('salesChart'), {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [{{ $totalSales }}, {{ $totalPaid }}, {{ $totalReceivable }}],
            ...
            new Chart(document.getElementById('receivablesChart'), {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [{{ $unpaidAmount }}, {{ $partialPaidAmount }},
                            {{ $overdueAmount }}
                        ],
            ...
            new Chart(document.getElementById('paymentsChart'), {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [{{ $cashPayments }}, {{ $transferPayments }}],
