...
@section('title', 'Edit Produk - ERP TADCO')
@section('page_title', 'Edit Data Produk')
@section('page_subtitle', 'Perbarui informasi produk, harga dasar (base price), dan skema diskon strata')
...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold mb-1"><i class="bi bi-pencil-square me-2 text-warning"></i>Edit Produk: {{ $product->product_name }}</h4>
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" id="formProduct">
            @csrf
            @method('PUT')
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="product_code" class="form-control bg-light border-start-0" value="{{ old('product_code', $product->product_code) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="product_name" class="form-control bg-light border-start-0" value="{{ old('product_name', $product->product_name) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" min="0" name="base_price" id="base_price" class="form-control bg-light border-start-0" value="{{ old('base_price', $product->base_price) }}" placeholder="0" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <select name="uom" id="uom_select" class="form-select bg-light border-start-0" required>
                                    <option value="BOX" {{ old('uom', $product->uom) === 'BOX' ? 'selected' : '' }}>BOX (Dus - Strata S1 s/d S5)</option>
                                    <option value="SACK" {{ old('uom', $product->uom) === 'SACK' ? 'selected' : '' }}>SACK (Karung - Strata S1 s/d S3)</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="net_weight" class="form-control bg-light border-start-0" value="{{ old('net_weight', $product->net_weight) }}" placeholder="Misal: 250GR, 10KG">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="segment" class="form-control bg-light border-start-0" value="{{ old('segment', $product->segment) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-flex align-items-end mb-2">
                            <div class="form-check form-switch">
                                ...
                                <label for="is_active" class="form-check-label fw-medium text-dark">Status Produk Aktif</label>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover align-middle mb-0" id="discountsTable">
                            ...
                            <tbody>
                                @foreach(['S1', 'S2', 'S3', 'S4', 'S5'] as $tier)
                                    @php
                                        $discountData = $discounts->get($tier);
                                    @endphp
                                    <tr class="strata-row" data-strata="{{ $tier }}">
                                        ...
                                        <td>
                                            <input
                                                ...
                                                class="form-control"
                                                value="{{ old('discounts.' . $tier . '.min_qty', $discountData->min_qty ?? ($loop->first ? 1 : '')) }}"
                                                placeholder="0"
                                            >
                                        </td>
                                        <td>
                                            <input
                                                ...
                                                class="form-control"
                                                value="{{ old('discounts.' . $tier . '.max_qty', $discountData->max_qty ?? '') }}"
                                                placeholder="Max Qty"
                                            >
                                        </td>
                                        <td>
                                            <div class="input-group">
                                                <input
                                                    ...
                                                    data-strata="{{ $tier }}"
                                                    value="{{ old('discounts.' . $tier . '.discount_percentage', $discountData->discount_percentage ?? 0) }}"
                                                    placeholder="0"
                                                >
