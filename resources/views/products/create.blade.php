...
<head>
    <meta charset="UTF-8">
    <title>Tambah Produk - ERP TADCO</title>
...
<div class="container py-5">
    <div class="mb-4">
        ...
        <small class="text-muted">Input item/barang baru ke sistem ERP</small>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="uom_secondary" class="form-control" value="{{ old('uom_secondary') }}">
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input
                                        ...
                                        class="form-control"
                                        value="{{ old('prices.' . $tier . '.discount_rate', 0) }}"
                                    >
                                </td>
                            </tr>
                        @endforeach
